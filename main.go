...
var _ CaloriesCalculator = new(Running)
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return (CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * MinInHours
}
...
var _ CaloriesCalculator = new(Walking)
...
func (w Walking) Calories() float64 {
	...
	// В формуле убрал лишние скобки и вынес общий множитель
	return (CaloriesWeightMultiplier + meanSpeed*meanSpeed/height*CaloriesSpeedHeightMultiplier) * w.Duration.Minutes() * w.Weight
}
...
var _ CaloriesCalculator = new(Swimming)
